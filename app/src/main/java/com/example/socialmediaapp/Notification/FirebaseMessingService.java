...
import com.example.socialmediaapp.Service;
...
public class FirebaseMessingService extends FirebaseMessagingService {
    ...
    @Override
    public void onMessageReceived(@NonNull RemoteMessage message1) {
        if(message1.getData().size() > 0){
            Map<String, String> map = message1.getData();
        ...
        super.onMessageReceived(message1);

    }

    @RequiresApi(api = Build.VERSION_CODES.O)
    private void createNormalNotification(String title, String message, String hisID, String hisImage) {
        NotificationChannel channel = new NotificationChannel(Service.NO_ID, "Message", NotificationManager.IMPORTANCE_HIGH);
        ...
        Notification notification = new Notification.Builder(this, Service.NO_ID)
    ...
    private void createOreoNotification(String title, String message, String hisID, String hisImage) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, Service.NO_ID);
